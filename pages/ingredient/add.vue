	...
	<view class="modal-container">
		<view class="modal-card">
			...
			<view class="card-header">
				<text class="card-title">添加食材</text>
			...
			<scroll-view class="card-content" scroll-y>
				...
				<!-- 食材名称 -->
				<view class="form-section">
					<view class="section-title">📝 食材名称</view>
					<input 
						type="text" 
				...
				<!-- 食材分类 -->
				<view class="form-section">
					<view class="section-title">🏷️ 食材分类</view>
				...
				<!-- 分量 -->
				<view class="form-section">
					<view class="section-title">⚖️ 分量（二选一）</view>
				...
				<view class="form-section">
					...
					<view class="date-group">
						<view class="date-item">
							<text class="date-label">添加日期</text>
							<picker mode="date" :value="ingredient.addDate" @change="onAddDateChange">
								<view class="date-value">{{ ingredient.addDate }}</view>
							</picker>
						</view>
						<view class="date-item">
							<text class="date-label">保鲜天数</text>
							<input 
								type="number" 
								v-model="freshDays" 
								placeholder="输入天数"
						...
						<view class="date-item">
							...
							<picker mode="date" :value="ingredient.expiryDate" @change="onExpiryDateChange">
								<view class="date-value">{{ ingredient.expiryDate }}</view>
							</picker>
						</view>
					</view>
				</view>
				...
				<view class="save-section">
					<view class="save-btn" @click="saveIngredient">保存</view>
				</view>
			</scroll-view>
		</view>
	</view>
